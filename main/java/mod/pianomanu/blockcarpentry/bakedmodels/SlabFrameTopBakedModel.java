...
public class SlabFrameTopBakedModel implements IDynamicBakedModel {
    ...
    public List<BakedQuad> getMimicQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData extraData) {
        ...
        if (mimic!=null) {
            ...
            //sides
            quads.add(createHalfQuad(v(0, 0, 0), v(0, 0, 1), v(0, 1, 1), v(0, 1, 0), texture));
            quads.add(createHalfQuad(v(0, 0, 0), v(0, 1, 0), v(1, 1, 0), v(1, 0, 0), texture));
            quads.add(createHalfQuad(v(0, 0, 1), v(1, 0, 1), v(1, 1, 1), v(0, 1, 1), texture));
            quads.add(createHalfQuad(v(1, 1, 0), v(1, 1, 1), v(1, 0, 1), v(1, 0, 0), texture));
