 ...
 */
public class PressurePlateFrameBlock extends PressurePlateBlock implements IFrameBlock {

    public PressurePlateFrameBlock(Sensitivity sensitivityIn, Properties propertiesIn) {
        super(sensitivityIn, propertiesIn);
        this.setDefaultState(this.stateContainer.getBaseState().with(POWERED, Boolean.FALSE).with(CONTAINS_BLOCK, Boolean.FALSE).with(LIGHT_LEVEL, 0));
    }
