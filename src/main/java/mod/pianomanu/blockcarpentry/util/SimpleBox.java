...
public class SimpleBox {
    private Vector3d NWU;
    private Vector3d NWD;
    private Vector3d NEU;
    private Vector3d NED;
    private Vector3d SWU;
    private Vector3d SWD;
    private Vector3d SEU;
    private Vector3d SED;
    ...
    public static SimpleBox create(IModelData extraData, IBakedModel model, Random rand) {
        Vector3d NWU = new Vector3d(0, 1, 0);
        Vector3d NWD = new Vector3d(0, 0, 0);
        Vector3d NEU = new Vector3d(1, 1, 0);
        Vector3d NED = new Vector3d(1, 0, 0);
        Vector3d SWU = new Vector3d(0, 1, 1);
        Vector3d SWD = new Vector3d(0, 0, 1);
        Vector3d SEU = new Vector3d(1, 1, 1);
        Vector3d SED = new Vector3d(1, 0, 1);
        return create(NWU, NWD, NEU, NED, SWU, SWD, SEU, SED, extraData, model, rand);
    }

    public static SimpleBox create(Vector3d NWU, Vector3d NWD, Vector3d NEU, Vector3d NED, Vector3d SWU, Vector3d SWD, Vector3d SEU, Vector3d SED, IModelData extraData, IBakedModel model, Random rand) {
    ...
    public static SimpleBox create(Vector3d NWU, Vector3d NWD, Vector3d NEU, Vector3d NED, Vector3d SWU, Vector3d SWD, Vector3d SEU, Vector3d SED,
                                   IModelData extraData, IBakedModel model, Random rand, TextureAtlasSprite sprite, int tintIndex) {
    ...
    public static SimpleBox create(Vector3d NWU, Vector3d NWD, Vector3d NEU, Vector3d NED, Vector3d SWU, Vector3d SWD, Vector3d SEU, Vector3d SED,
                                   IModelData extraData, IBakedModel model, Random rand, TextureAtlasSprite sprite,
    ...
    private SimpleBox(Vector3d NWU, Vector3d NWD, Vector3d NEU, Vector3d NED, Vector3d SWU, Vector3d SWD, Vector3d SEU, Vector3d SED,
                      IModelData extraData, IBakedModel model, Random rand, TextureAtlasSprite sprite,
                      boolean renderUp, boolean renderDown, boolean renderNorth, boolean renderEast, boolean renderSouth, boolean renderWest,
                      List<Direction> directions, List<Integer> rotations,
                      int tintIndex, boolean keepDefaultUV, int overlayIndex, boolean doNotMoveOverlay) {
    ...
    private void createQuadFace(List<BakedQuad> quads, Vector3d v1, Vector3d v2, Vector3d v3, Vector3d v4, Direction originalDirection, Direction newDirection, int rotation, boolean invert) {
    ...
    private TextureAtlasSprite overlayTexture(Direction direction) {
        switch (direction) {
            case UP:
                return modelInformation.upTexture;
            case DOWN:
                return modelInformation.downTexture;
            case NORTH:
                return modelInformation.northTexture;
            case EAST:
                return modelInformation.eastTexture;
            case SOUTH:
                return modelInformation.southTexture;
            case WEST:
                return modelInformation.westTexture;
            default:
