...
public class SimpleBox {
    ...
    private Vec3 SEU;
    private Vec3 SED;
    private final ModelData extraData;
    ...
    public static SimpleBox create(ModelData extraData, BakedModel model, RandomSource rand) {
    ...
    public static SimpleBox create(Vec3 NWU, Vec3 NWD, Vec3 NEU, Vec3 NED, Vec3 SWU, Vec3 SWD, Vec3 SEU, Vec3 SED,
                                   ModelData extraData, BakedModel model, RandomSource rand, TextureAtlasSprite sprite, int tintIndex) {
    ...
    public static SimpleBox create(Vec3 NWU, Vec3 NWD, Vec3 NEU, Vec3 NED, Vec3 SWU, Vec3 SWD, Vec3 SEU, Vec3 SED,
                                   ModelData extraData, BakedModel model, RandomSource rand, TextureAtlasSprite sprite,
    ...
    public List<BakedQuad> getQuads() {
        ...
        boolean useSimpleQuadCalc = CornerUtils.isCuboid(NWU, NEU, SWU, SEU, NWD, NED, SWD, SED) || !BCModConfig.USE_COMPLEX_QUAD_CALCULATIONS.get() || Boolean.TRUE.equals(extraData.get(FrameBlockTile.REMAIN_RECTANGLE));
