...
public class Registration {
    ...
    public static final RegistryObject<BlockEntityType<SignFrameTile>> SIGN_ILLUSION_TILE = TILES.register("illusion_sign", () -> BlockEntityType.Builder.of(SignFrameTile::new, STANDING_SIGN_ILLUSIONBLOCK.get(), WALL_SIGN_ILLUSION_BLOCK.get()).build(null));
