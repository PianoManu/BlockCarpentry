        ...
        if (mimic != null && !(mimic.getBlock() instanceof FrameBlock)) {
            ...
            if (location != null) {
                ...
                if (model != null) {
                    ...
                    List<BakedQuad> quads = new ArrayList<>(ModelHelper.createSixFaceCuboid(0f, 1f, 0f, 1 / 16f, 0f, 1f, mimic, model, extraData, rand, tintIndex, renderNorth, renderSouth, renderEast, renderWest, true, true, rotation));
