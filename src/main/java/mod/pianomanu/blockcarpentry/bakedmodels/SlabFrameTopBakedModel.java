...
public class SlabFrameTopBakedModel implements IDynamicBakedModel {
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData extraData) {
        ...
        //sides
        quads.add(createQuad(v(0,0.5,0), v(0,0.5,1), v(0,1,1), v(0,1,0),texture));
        quads.add(createQuad(v(0,0.5,0), v(0,1,0), v(1,1,0), v(1,0.5,0),texture));
        quads.add(createQuad(v(0,0.5,1), v(1,0.5,1), v(1,1,1), v(0,1,1),texture));
        quads.add(createQuad(v(1,1,0), v(1,1,1), v(1,0.5,1), v(1,0.5,0),texture));
    ...
    public List<BakedQuad> getMimicQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData extraData) {
        ...
        if (mimic!=null && state != null) {
            ...
            quads.add(createQuad(v(0, 1, 0), v(0, 1, 1), v(1, 1, 1), v(1, 1, 0), texture));
            //sides
            quads.add(createHalfQuad(v(0, 0.5, 1), v(0, 1, 1), v(0, 1, 0), v(0, 0.5, 0), texture));
            quads.add(createHalfQuad(v(0, 0.5, 0), v(0, 1, 0), v(1, 1, 0), v(1, 0.5, 0), texture));
            quads.add(createHalfQuad(v(1, 0.5, 1), v(1, 1, 1), v(0, 1, 1), v(0, 0.5, 1), texture));
            quads.add(createHalfQuad(v(1, 1, 1), v(1, 0.5, 1), v(1, 0.5, 0), v(1, 1, 0), texture));
             */
