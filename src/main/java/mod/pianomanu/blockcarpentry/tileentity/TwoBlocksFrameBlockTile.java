 ...
 */
public class TwoBlocksFrameBlockTile extends TileEntity implements IFrameTile {
    ...
    public Float friction_2 = Registration.FRAMEBLOCK.get().getSlipperiness();
    ...
    private static List<FrameBlockTile.TagPacket<?>> initTagPackets() {
        ...
        packets.add(new FrameBlockTile.TagPacket<>("mimic_2", BlockState.class, Blocks.AIR.getDefaultState()));
    ...
    public Float getSlipperiness_2() {
        return friction_2;
    }
    ...
    public void onDataPacket(NetworkManager net, SUpdateTileEntityPacket pkt) {
        onDataPacket(pkt, TwoBlocksFrameBlockTile.class, world, this.pos, getBlockState());
    }
    ...
    public IModelData getModelData() {
        return new ModelDataMap.Builder()
                .withInitial(MIMIC_1, mimic)
                .withInitial(TEXTURE_1, texture)
                .withInitial(DESIGN_1, design)
                .withInitial(DESIGN_TEXTURE_1, designTexture)
                .withInitial(OVERLAY_1, overlay)
                .withInitial(ROTATION_1, rotation)
    ...
    @Override
    public void read(BlockState state, @Nonnull CompoundNBT tag) {
        super.read(state, tag);
        IFrameTile.super.read(tag, TwoBlocksFrameBlockTile.class);
    ...
    public CompoundNBT write(CompoundNBT tag) {
        super.write(tag);
        IFrameTile.super.write(tag, TwoBlocksFrameBlockTile.class);
        tag.put("mimic_2", NBTUtil.writeBlockState(mimic_2 != null ? mimic_2 : Blocks.AIR.getDefaultState()));
        return tag;
    }

    public boolean applyToUpper() {
        return this.getMimic_2() != null && this.getMimic_2() != Blocks.AIR.getDefaultState();
    }
    ...
    private void copyOutdatedData(CompoundNBT tag) {
        if (tag.contains("mimic_1"))
            this.mimic = read(tag, "mimic_1", BlockState.class, Blocks.AIR.getDefaultState());
